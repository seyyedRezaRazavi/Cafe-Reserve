...
<head>
    ...
    <style>
        @font-face {
            ...
            src: url('{{asset('yekan')}}/Yekan.eot?#iefix') format('Yekan-opentype'),
...
<div class="container-login100" style="background-image: url('{{asset('login_template')}}/images/bg-01.jpg');">
    ...
    <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
        ...
        @endif
        <form class="login100-form " action="{{route('user.first.update')}}" method="post">
            @csrf
            @method('post')
				<span class="login100-form-title p-b-37" style=" font-family: 'B Yekan' ">تبریک</span>

            <div class="text-center p-b-20 ">
                <span class="txt1" style=" font-family: 'B Yekan';direction: rtl;font-size: 0.9em">به جمع مستر فانی ها خیلی خوش آمدید.</span>
            </div>
            <div class="wrap-input100  m-b-20" >
                <input class="input100" type="text" name="name" placeholder="نام و نام خانوادگی" dir="rtl" style=" font-family: 'B Yekan';direction: rtl " required minlength="5">
                <span class="focus-input100"></span>
            </div>
            <div class="text-center p-b-50 ">
                <span class="txt1" style=" font-family: 'B Yekan';direction: rtl;font-size: 0.9em">لطفا نام و نام خانوادگی خود را وارد کنید</span>
            </div>


            <div class="container-login100-form-btn">
                <button class="login100-form-btn" style=" font-family: 'B Yekan';direction: rtl  ">ورود / ثبت نام</button>
            </div>
