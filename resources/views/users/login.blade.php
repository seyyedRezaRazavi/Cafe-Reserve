...
<div class="container-login100" style="background-image: url('{{asset('login_template')}}/images/bg-01.jpg');">
    ...
    <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
        ...
        @endif
        <form class="login100-form " action="{{route('user.login.send_sms')}}" method="post">
            @csrf
            @method('post')
				<span class="login100-form-title p-b-37" style=" font-family: 'B Yekan' ">ورود / ثبت نام</span>

            <div class="wrap-input100  m-b-20" >
                <input class="input100" type="tel" name="tell" placeholder="مثلا: 09121234567" dir="rtl" style=" font-family: 'B Yekan';direction: rtl " required>
                <span class="focus-input100"></span>
            </div>
            <div class="text-center p-b-50 ">
					<span class="txt1" style=" font-family: 'B Yekan';direction: rtl;font-size: 0.9em">*لطفا جهت ورود یا ثبت نام در سیستم <strong>کافه مستر فان</strong> شماره تلفن همراه خود را وارد کنید</span>
            </div>
